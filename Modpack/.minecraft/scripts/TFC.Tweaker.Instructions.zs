...
//mods.Terrafirmacraft.ItemHeat.addRecipe(<terrafirmacraft:item.Ore:20>,<minecraft:coal:1>);
//mods.Terrafirmacraft.ItemHeat.addRecipe(<terrafirmacraft:item.Ore:20>,<minecraft:coal>);
...
mods.Terrafirmacraft.Quern.addRecipe(<terrafirmacraft:item.Powder:1>*2, <terrafirmacraft:item.Clay>);
mods.Terrafirmacraft.Quern.addRecipe(<terrafirmacraft:item.Powder:2>*2, <terrafirmacraft:item.coal:1>);
mods.Terrafirmacraft.Quern.addRecipe(<terrafirmacraft:item.Powder:2>*2, <terrafirmacraft:item.coal>);
